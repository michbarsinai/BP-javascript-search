...
public class SimpleEventSelectionStrategyTest {
    ...
    public void testEmptySet() {
        assertEquals(EventSelectionResult.NONE_REQUESTED,
                sut.select(Collections.emptySet(), Collections.emptyList()) );
    }
    ...
    public void testUnanimousCase() {
        ...
        assertEquals(EventSelectionResult.selected(expected), sut.select(sets, Collections.emptyList()));
    }
